    ...
    <div class="container max-w-screen-xl mx-auto">
        <a href="#">
            <div class="relative">
                ...
                <span
                    class="absolute top-5 left-5 bg-white px-3 py-1 flex items-center gap-2 shadow-lg font-medium"><span
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 pt-5 ">
